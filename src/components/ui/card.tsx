...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "surface-glow rounded-[1.75rem] border border-white/80 p-6 shadow-[0_18px_45px_rgba(12,31,74,0.08)]",
        className
      )}
      {...props}
    />
...
const CardTitle = React.forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("font-display text-[1.35rem] font-bold tracking-[0.02em] text-primary", className)}
      {...props}
    />
  )
);
